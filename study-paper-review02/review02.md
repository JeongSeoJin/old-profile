...
---
## Conclusion
This paper presents that the low-cost 3d-printed actuator with zero-shot transfer policy, evaluating actuator's reliability and demonstrating the locomotion of the robot. Remarkably, the overall building/evaluation process of humanoid robot was impressive including actuator designs/evaluations and Reinforcement Learning deployment. Furthermore, '[Berkeley Humanoid Lite Docs](https://berkeley-humanoid-lite.gitbook.io/docs)' provide detailed documentation and instructions. Building the full humanoid robot with 3d-printed actuator, deploying the RL model on the robot, highly inspired me and boosted my confidence  
